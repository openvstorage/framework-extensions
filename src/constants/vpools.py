...
PROXY_CONFIG_ABM = os.path.join(PROXY_PATH, 'abm')                      # ovs/vpools/{0}/proxies/{1}/config/abm
PROXY_CONFIG_MAIN = os.path.join(PROXY_PATH, 'main')                    # ovs/vpools/{0}/proxies/{1}/config/main
