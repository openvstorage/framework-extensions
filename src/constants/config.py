...
OVS_CONFIG = os.path.join(os.path.sep, 'opt', 'OpenvStorage', 'config')                                 # /opt/OpenvStorage/config
...
COMPONENTS_KEY = os.path.join(os.path.sep, 'ovs', 'machines', '{0}', 'components')                      # /ovs/machines/{0}/components
